...
@section('title', 'Test TailwindCSS')

@section('content')
<div class="min-h-screen bg-gray-50">
    <!-- Test basic TailwindCSS -->
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-center text-blue-600 mb-8">Test TailwindCSS</h1>
        ...
        <div class="text-brand-blue text-xl font-semibold mb-4">
            Custom Brand Blue Text
        </div>
        ...
        <!-- Test button -->
        <button class="bg-brand-blue hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
            Test Button
        </button>
    </div>
</div>
    ...
    <section id="tentang" class="py-16 md:py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-text-primary mb-4 scroll-animate">Tentang Sistem
                    Rekapitulasi Kami</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div class="p-6 scroll-animate delay-100">
                ...
                <div class="p-6 scroll-animate delay-200">
